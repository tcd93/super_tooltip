...
class SuperTooltip {
  ...
  late OverlayEntry _ballonOverlay;
  ...
  void show(BuildContext targetContext) {
    ...
    if (Overlay.of(targetContext) == null) {
      throw 'Invalid targetContext';
    }
    ...
    switch (_popupDirection) {
      ...
      case TooltipDirection.left:
        ...
        if (_left != null) {
          ...
          calcMaxWidth =
              min((_maxWidth ?? constraints.maxWidth), _targetCenter.dx) - _outSidePadding;
        }
        break;
...
class _ShapeOverlay extends ShapeBorder {
  ...
  _ShapeOverlay(
      this.cr, this.clipAreaShape, this.clipAreaCornerRadius, this.outsideBackgroundColor);
  ...
  @override
  Path getInnerPath(Rect rect, {TextDirection? textDirection}) {
    return new Path()..addOval(cr ?? rect);
  }

  @override
  Path getOuterPath(Rect rect, {TextDirection? textDirection}) {
    final outer = new Path()..addRect(rect);
  ...
  @override
  ShapeBorder scale(double t) {
    return new _ShapeOverlay(cr, clipAreaShape, clipAreaCornerRadius, outsideBackgroundColor);
  }
}
...
class _AnimationWrapper extends StatefulWidget {
  ...
  _AnimationWrapper({required this.builder});
